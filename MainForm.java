...
public class MainForm {
	...
	private void createJFrame(){
		...
		frame.setTitle("Choose/Enter Recipe");
	...
	private class AddRecipeListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			Recipe r = new Recipe();
			r.setRecipeName(recipeNameTextField.getText());
			r.setInstructions(directionsTextArea.getText());
	...
	private class IngredientListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			i.setRecipeName(ingredientNameTextField.getText());
		...
		public void valueChanged(ListSelectionEvent arg0) {
			if (list.getSelectedIndex() != -1) {
		        //No selection, disable fire button.
		           ...
		           ShowRecipeForm detail = new ShowRecipeForm(r);
